...
public class FZPermissionNotification: NSObject {
    ...
    public func requestNotificationPermision(for type: FZPermissionNotificationOptions, callback: @escaping FZPermission.FZPermissionCallBack) {
        ...
        if #available(iOS 10.0, *) {
            ...
            center.requestAuthorization(options: self.transformToAuthorizationOptions(type)) { [weak self] (_, _) in
